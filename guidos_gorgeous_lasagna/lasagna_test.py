"""Tests for Guidos Gorgeous Lasagna"""

import unittest
import pytest

# For this first exercise, it is really important to be clear about how we
# are importing names for tests. To that end, we are putting a try/catch
...
class LasagnaTest(unittest.TestCase):
    """Formal test cases for the exercise"""
    ...
    def test_bake_time_remaining(self):
        input_data = [1, 2, 5, 10, 15, 23, 33, 39, 50, 62, 102]
        result_data = [max(40 - item, 0) for item in input_data]
