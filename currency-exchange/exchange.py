"""Utility functions for exchanging currency"""
...
def exchangeable_value(
    ...
    exchange_rate_with_spread = exchange_rate + (spread_percent * exchange_rate)

    gross_value = exchange_money(budget, exchange_rate_with_spread)
    number_of_bills = get_number_of_bills(gross_value, denomination)
